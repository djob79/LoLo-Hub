            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <BlurFade delay={0.2 + (4 * 0.05)}>
                <div className="flex flex-row items-center justify-center mt-2 gap-2">
                  <Input className="overflow-hidden text-ellipsis min-w-[300px]" readOnly value={'loadstring(game:HttpGet("https://raw.githubusercontent.com/vsqzz/NEWESTHUBBY/refs/heads/main/new1"))()"))()'}/>
                  <CopyButton text={'loadstring(game:HttpGet("https://raw.githubusercontent.com/vsqzz/NEWESTHUBBY/refs/heads/main/new1"))()'} />
